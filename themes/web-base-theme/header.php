...
<html lang="<?php language_attributes(); ?>" dir="ltr">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo THEMEPATH . "images/assets/57x57.png"; ?>">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo THEMEPATH . "images/assets/60x60.png"; ?>">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo THEMEPATH . "images/assets/72x72.png"; ?>">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo THEMEPATH . "images/assets/76x76.png"; ?>">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo THEMEPATH . "images/assets/114x114.png"; ?>">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo THEMEPATH . "images/assets/120x120.png"; ?>">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo THEMEPATH . "images/assets/144x144.png"; ?>">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo THEMEPATH . "images/assets/152x152.png"; ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo THEMEPATH . "images/assets/180x180.png"; ?>">
    <link rel="icon" type="image/png" sizes="192x192"  href="<?php echo THEMEPATH . "images/assets/192x192.png"; ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo THEMEPATH . "images/assets/32x32.png"; ?>">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo THEMEPATH . "images/assets/96x96.png"; ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo THEMEPATH . "images/assets/16x16.png"; ?>">
  ...
  <body <?php body_class(); ?>>
    <header id="main_header">
      <div class="inner_wrapper flex">
        ...
        <div id="main_menu" class="wp_menu_main">
          <div class="obscure"></div>
          <?php get_search_form(); ?>
          <?php wp_nav_menu(array('theme_location' => 'menu-1', 'menu_class'=>'header_nav_menu', 'container'=>'nav')); ?>
        </div>
        ...
        <svg id="hamburger" class="icn_hamburger" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 0 24 24" width="48px" fill="#FFFFFF"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>
      </div>
    </header>
